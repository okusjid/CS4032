document.addEventListener("DOMContentLoaded", function() {
  ...
  form.addEventListener("submit", function(e) {
      ...
      // Validation (Example: Check if first name is filled out)
      ...
      const applicationData = {
          ...
          resume: form.resume.value, // Note: This will only capture the file name, not the file itself
          ...
          // referenceContact: form.referenceContact.value,
